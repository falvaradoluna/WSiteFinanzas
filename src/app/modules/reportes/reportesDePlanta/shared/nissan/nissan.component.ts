...
export class NissanComponent implements OnInit {
  ...
  saveDetailsConfigurationTemplate(): void{
    ...
    if(this.dataDetails.length > 0) {
        ...
        if(details != undefined) {
          ...
          // if(details.departamentoReporte != undefined){
          //   details.departamentoReporte.forEach(d =>{
          //     this.selectedDeptos.push({id : d.idDepartamento, descripcion: d.descripcion });
          //   });
          // }
          
          // if(details.estadoResultadosIReporte != undefined){
          //   details.estadoResultadosIReporte.forEach(er =>{
          //     this.selectedER.push({idEstadoResultadosI : er.idEstadoResultadosI,titulo : er.titulo });
          //   });
          // }
        } else {
          this.dataDetails.push({
                                  ...
                                  otro: null//,
                                  // departamentoReporte: null,
                                  // estadoResultadosIReporte: null
  ...
  private loadInfo(dataSource: IPlantillaDetalle): void{
    ...
    // if(dataSource.departamentoReporte != undefined){
    //   dataSource.departamentoReporte.forEach(d =>{
    //     this.selectedDeptos.push({id : d.idDepartamento, descripcion: d.descripcion });
    //   });
    // }
    
    // if(dataSource.estadoResultadosIReporte != undefined){
    //   dataSource.estadoResultadosIReporte.forEach(er =>{
    //     this.selectedER.push({idEstadoResultadosI : er.idEstadoResultadosI,titulo : er.titulo });
    //   });
    // }
